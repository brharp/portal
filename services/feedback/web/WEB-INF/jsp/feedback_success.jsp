	...
	<body>
		<div id="bodyContent">
			...
			<table align="center">
				<tr>
					<td>
						<p><i> MyPortico feedback submitted successfully!</i><p>
						<p>
						Thank you for your feedback/questions/comments!
						</p>
					</td>
				</tr>
				<tr>
					<td align="center">
						<p>
						<br />
						<a href="/portal/Feedback">Return</a>&nbsp;&nbsp;&nbsp;<a href="javascript:window.close()">Close</a>
						</p>
						</td>
					</tr>
				</table>
