...
<c:choose>
	...
	<form class="myportico-form" action="<portlet:actionURL></portlet:actionURL>" method="post">		
			<ul class="myportico-ulist">
				<c:forEach var='item' items='${moreUserNotification}'>							
					<c:if test='${empty item["mark_read"]}'>
			...
			<c:if test="${empty more && userNotificationSize > 5}">
				<img style="vertical-align:middle;" src="${pageContext.request.contextPath}/images/expand.gif" /><a href="<portlet:renderURL>
