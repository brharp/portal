        ...
        <c:when test="${settingsBean.selectedFeed != null}">    
            ...
            <table style="border-style: none; padding: 4; width: 100%">
                ...
                <table style="border-style: solid; border-width: thin; padding: 8px">
                    <tr><td>
                        <div class="portlet-font">
                            ...
                            <a href="<c:out value="${feedBean.feed.link}"/>" style="font-weight: bolder" target="<c:out value="${settingsBean.windowTarget}"/>"><c:out value="${feedBean.feed.title}"/></a>
                ...
                <c:forEach var="entry" items="${entries}">
                    <tr><td>
                        <div class="portlet-font">
                            <a href="<c:out value="${entry.link}"/>" target="<c:out value="${settingsBean.windowTarget}"/>"><c:out value="${entry.title}"/></a>
