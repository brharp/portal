 ...
 */
public class GotMailTestLoop {
    
	public static final int MAX_DATA = 1000;
	public long timeData[][] = new long[MAX_DATA][4];
	public int timeDataIndex = 0;
	public static java.text.DecimalFormat fmt = new java.text.DecimalFormat("0.000");
	
    /** Creates a new instance of ImapClient */
    public GotMailTestLoop() {
    }
    ...
    public GotMailVO checkMail(String mailServer, int port, 
        ...
        timeData[timeDataIndex][3] =vo.getCountUnseen();
        
        System.out.print("" + timeDataIndex + ", ");
    	System.out.print(" partial=" + fmt.format( ((float)(timeData[timeDataIndex][1] - timeData[timeDataIndex][0]))/1000.0));
    	
        System.out.print(" total=" + fmt.format(((float)(timeData[timeDataIndex][2] - timeData[timeDataIndex][0]))/1000.0));
        System.out.print(" dif=" + fmt.format(((float)(timeData[timeDataIndex][2] - timeData[timeDataIndex][1]))/1000.0));
        System.out.println(" cnt=" + timeData[timeDataIndex][3]);
    ...
    public static void main(String[] args) {
        ...
        */
        try {
            GotMailTestLoop obj = new GotMailTestLoop();
            obj.timeDataIndex = 0;
            ...
            for (int i = 0; i < obj.timeDataIndex; i++) {
                ...
                System.out.print(" dif=" + fmt.format(((float)(obj.timeData[i][2] - obj.timeData[i][1]))/1000.0));
                System.out.println(" cnt=" + obj.timeData[i][3]);
            }
            System.out.println("Times");
            for (int i = 0; i < obj.timeDataIndex; i++) {
            	System.out.println(obj.timeData[i][0]+","+obj.timeData[i][1]+","+obj.timeData[i][2]+","+obj.timeData[i][3]);            	
            }
