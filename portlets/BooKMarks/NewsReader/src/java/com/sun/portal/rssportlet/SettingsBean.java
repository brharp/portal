...
public class SettingsBean {
	...
	private String startFeed = null;
    private LinkedList feeds;
    private LinkedList titleList; //titles for corresponding feed
    ...
    */
     ...
     * 
     * Note: We can't do that any more because the locked feeds always remain at the
     * beginning of the list. LJ
     * 
     */
    /*
    ...
    public void setStartFeed(String feed) {
    	//System.out.println(" Set startFeed: " + feed);
    	this.startFeed = feed;
    }
