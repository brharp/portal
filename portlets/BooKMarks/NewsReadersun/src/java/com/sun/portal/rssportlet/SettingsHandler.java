    ...
    private void setFeedTitleList(LinkedList feeds) {
        ...
        while (it.hasNext()) {
            ...
            try{
                ...
                getPortletConfig().getPortletContext().log("could not add feed:" + feed, mue);
            } catch (FeedException fe) {
                getPortletConfig().getPortletContext().log("could not add feed:" + feed, fe);
            } catch (IOException ioe) {
                getPortletConfig().getPortletContext().log("could not add feed:" + feed, ioe);
            }
        }
