...
<c:catch var="exception">    
    ...
    <form name="inputForm" target="_self" method="POST" action="<%=actionURL.toString()%>">
        <table border="0" style="align: center">
            ...
            <tr><td align="center">
                <input class="portlet-form-input-field" name="<%=FormNames.SUBMIT_FINISH%>" type="submit" value="<fmt:message key="finished"/>"/>
                <input class="portlet-form-input-field" name="<%=FormNames.SUBMIT_CUSTOM%>" type="submit" value="<fmt:message key="custom"/>"/>
                <input class="portlet-form-input-field" name="<%=FormNames.SUBMIT_CANCEL%>" type="submit" value="<fmt:message key="cancel"/>"/>
            </td>
            </tr>
