...
public class T2HTML {
	...
	public static String convertText2HTML(String payload) {
		...
		for (int i=0; i<paras.length; i++) {
			...
			sb.append(parasToHTML(paragraph));
			//System.out.println("Paragraph Acc:" + sb);
		}
		/*
	...
	public static String parasToHTML(String line) {
		StringBuffer sb = new StringBuffer();
		String[] href = line.split(HTTP_REG_EX);
		if (href == null || href.length < 2) {
